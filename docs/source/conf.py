...
latex_documents = [
    (master_doc, 'phynet.tex', 'phynet Documentation',
     'COM', 'manual'),
]
...
man_pages = [
    (master_doc, 'phynet', 'phynet Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'phynet', 'phynet Documentation',
     author, 'phynet', 'One line description of project.',
     'Miscellaneous'),
]
